...
jQuery.validator.addMethod("dateTimeBR", function(value, element) {
	var retorno = true;
	 ...
	 //contando chars
	if(value.length!=16) retorno = false;
	 // dividindo data e hora
	if(value.substr(10,1)!=' ') retorno = false; // verificando se hÃ¡ espaÃ§o
	var arrOpcoes = value.split(' ');
	if(arrOpcoes.length!=2) retorno = false; // verificando a divisÃ£o de data e hora
	// verificando data
	...
	if(horario.length!=5||isNaN(hora)||isNaN(minuto)||hora>23||minuto>59||doispontos!=":")retorno = false;
